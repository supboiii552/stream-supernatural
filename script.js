...
const episodesData = {
  ...
  "5": [{"ep": 1, "title": "Sympathy for the Devil"}, {"ep": 2, "title": "Good God, Y'all!"}, {"ep": 3, "title": "Free to Be You and Me"}, {"ep": 4, "title": "The End"}, {"ep": 5, "title": "Fallen Idols"}, {"ep": 6, "title": "I Believe the Children Are Our Future"}, {"ep": 7, "title": "The Curious Case of Dean Winchester"}, {"ep": 8, "title": "Changing Channels"}, {"ep": 9, "title": "The Real Ghostbusters"}, {"ep": 10, "text": "Abandon All Hope..."}, {"ep": 11, "title": "Sam, Interrupted"}, {"ep": 12, "title": "Swap Meat"}, {"ep": 13, "title": "The Song Remains the Same"}, {"ep": 14, "title": "My Bloody Valentine"}, {"ep": 15, "title": "Dead Men Don't Wear Plaid"}, {"ep": 16, "title": "Dark Side of the Moon"}, {"ep": 17, "title": "99 Problems"}, {"ep": 18, "title": "Point of No Return"}, {"ep": 19, "title": "Hammer of the Gods"}, {"ep": 20, "title": "The Devil You Know"}, {"ep": 21, "title": "Two Minutes to Midnight"}, {"ep": 22, "title": "Swan Song"}],
...
// LOAD VIDEO WITH FULLSCREEN & STRETCH FIX
...
nBtn.onclick = () => {
    ...
    const nextEp = episodesData[s].find(item => item.ep === e + 1);
    
    if (nextEp) {
        loadVideo(s, e + 1);
    } else if (episodesData[s + 1]) {
        loadVideo(s + 1, 1);
    }
};

// SEARCH LOGIC
sInput.oninput = (event) => {
